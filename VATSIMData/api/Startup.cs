    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapGet("pilots/callsign/{callsign}/altitude/{altitude}", PilotsEndpoint.AltitudeEndpoint);
                endpoints.MapGet("pilots/callsign/{callsign}/groundspeed/{groundspeed}", PilotsEndpoint.GroundspeedEndpoint);
                endpoints.MapGet("pilots/callsign/{callsign}/latitude/{latitude}", PilotsEndpoint.LatitudeEndpoint);
                endpoints.MapGet("pilots/callsign/{callsign}/longitude/{longitude}", PilotsEndpoint.LongitudeEndpoint);
